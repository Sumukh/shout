...
config.usernameNick = 'cs61a-student';
...
function username(username) {
	...
	config.usernameNick = username; 
	var dataset = { id: 2, text: '/nick '+username }
	input(dataset);
}
...
function connect(params) {
	...
	console.log("Config has "+config.usernameNick);
	...
	client.nick(config.usernameNick);
	client.user(config.usernameNick, config.usernameNick);
...
function auth(password) {
	//Faked out. Don't need passwords.
